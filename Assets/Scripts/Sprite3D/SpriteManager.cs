namespace DPlay.Sprite3D
{
    ...
    public class SpriteManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (this.mainCamera == null) throw new System.Exception("Could not find the main camera.");
            ...
            if (this.rootTransform == null) throw new System.Exception("There is no root transform.");
            ...
            if (this.bodyTransform == null) throw new System.Exception("There is no root sprite body.");
        ...
        private void LateUpdate()
        {
            ...
            this.rootTransform.rotation =
                Quaternion.Euler(
                    0.0f,
                    this.mainCamera.transform.rotation.eulerAngles.y,
                    0.0f);
        }
    }
}